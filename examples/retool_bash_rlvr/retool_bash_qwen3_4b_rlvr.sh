...
SLIME_BASH_COMMAND_TIMEOUT_S="${SLIME_BASH_COMMAND_TIMEOUT_S:-30}"
SLIME_BASH_MAX_COMMAND_TIMEOUT_S="${SLIME_BASH_MAX_COMMAND_TIMEOUT_S:-120}"
SLIME_BASH_ROLLOUT_TIMEOUT_S="${SLIME_BASH_ROLLOUT_TIMEOUT_S:-300}"
SLIME_BASH_BATCH_TIMEOUT_S="${SLIME_BASH_BATCH_TIMEOUT_S:-7200}"
SLIME_BASH_REWARD_TIMEOUT_S="${SLIME_BASH_REWARD_TIMEOUT_S:-60}"
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"SLIME_BASH_COMMAND_TIMEOUT_S\": \"${SLIME_BASH_COMMAND_TIMEOUT_S}\",
    \"SLIME_BASH_MAX_COMMAND_TIMEOUT_S\": \"${SLIME_BASH_MAX_COMMAND_TIMEOUT_S}\",
    \"SLIME_BASH_ROLLOUT_TIMEOUT_S\": \"${SLIME_BASH_ROLLOUT_TIMEOUT_S}\",
    \"SLIME_BASH_BATCH_TIMEOUT_S\": \"${SLIME_BASH_BATCH_TIMEOUT_S}\",
    \"SLIME_BASH_REWARD_TIMEOUT_S\": \"${SLIME_BASH_REWARD_TIMEOUT_S}\",
